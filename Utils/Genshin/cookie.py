...
def get_cookies(user_id: int) -> Dict[Cookie, Any]:
    ...
    return None if cookies == None else {
                                            Cookie.LTUID_V2: cookies[0],
                                            Cookie.LTMID_V2: RSA_CRYPTO.decrypt_msg(__PRIVATE_KEY, cookies[1]),
                                            Cookie.LTOKEN_V2: RSA_CRYPTO.decrypt_msg(__PRIVATE_KEY, cookies[2]),
                                        }
